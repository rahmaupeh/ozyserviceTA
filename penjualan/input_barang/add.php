...
<h3 class="page-header"></i> Input Barang</h3>
  ...
  <div class="col-md-9">
    ...
    <div class="col-lg-10">
      <input type="text" class="form-control" id="inputkode_barang" readonly="readonly" placeholder="Kode Barang" name="kode_barang" value="<?php echo $no_id;?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputkode_barang" class="col-lg-2 control-label">No Parts</label>
    <div class="col-lg-10">
      <input type="text" class="form-control" id="inputkode_barang" placeholder="No Parts" name="no_parts">
    </div>
  </div>
  <div class="form-group">
